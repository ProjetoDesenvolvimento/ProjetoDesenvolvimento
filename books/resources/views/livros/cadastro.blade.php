        ...
        <div class="col-md-6" id="mutant">
            ...
            <div class="form-group">
                <label for="isbn-select" class="control-label">
                    ISBN <span class="glyphicon glyphicon-info-sign" title="Este é um código que identifica um livro particular e faz ele único entre tudos os demais."></span>:
                </label>
    ...
    {!! Form::close() !!}
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#isbn-select").select2({
                    placeholder: "Clique aqui e informe algo do livro",
